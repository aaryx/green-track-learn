...
const AnalysisSection = () => {
  return (
    <div className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background to-primary/5">
      <div className="max-w-5xl mx-auto">
        ...
        <Card className="mb-8 animate-fade-in border-primary/20 hover:shadow-[var(--shadow-elegant)] transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-2xl">
              <Users className="h-6 w-6 text-primary" /> Who Participated?
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-lg hover-scale">
                <School className="h-8 w-8 text-primary" />
                <div>
                  <p className="font-semibold">Schools & Colleges</p>
              ...
              <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-lg hover-scale">
                ...
                <div>
                  <p className="font-semibold">Homes & Households</p>
                  <p className="text-sm text-muted-foreground">Second highest</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-lg hover-scale">
                <Store className="h-8 w-8 text-primary" />
                <div>
                  <p className="font-semibold">Shops, Restaurants, Cafes</p>
                  <p className="text-sm text-muted-foreground">Commercial spaces</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-lg hover-scale">
                <Building2 className="h-8 w-8 text-primary" />
                <div>
                  <p className="font-semibold">Offices & Workplaces</p>
                  <p className="text-sm text-muted-foreground">Corporate sector</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-lg hover-scale">
                <FlaskConical className="h-8 w-8 text-primary" />
                <div>
                  <p className="font-semibold">Laboratories & Clinics</p>
                  <p className="text-sm text-muted-foreground">Medical facilities</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-primary/5 rounded-lg hover-scale">
                <Trees className="h-8 w-8 text-primary" />
                <div>
                  <p className="font-semibold">Public Parks & Streets</p>
        ...
        <Card className="mb-8 animate-fade-in border-primary/20 hover:shadow-[var(--shadow-elegant)] transition-shadow">
          ...
          <CardContent>
            ...
            <div className="bg-primary/10 p-4 rounded-lg">
              <p className="text-sm text-center text-muted-foreground">📊 Pie chart: organic vs plastic vs paper distribution</p>
            </div>
          </CardContent>
        </Card>
        ...
        {/* Problems Identified */}
        <Card className="mb-8 animate-fade-in border-destructive/20 hover:shadow-[var(--shadow-elegant)] transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-2xl">
              <AlertTriangle className="h-6 w-6 text-destructive" /> Problems Identified
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-8 animate-fade-in border-primary/20 hover:shadow-[var(--shadow-elegant)] transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-2xl">
              <ShieldCheck className="h-6 w-6 text-primary" /> Precautions & Best Practices
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-5 bg-primary/5 rounded-lg hover-scale border border-primary/10">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold">Households</h3>
                </div>
        ...
        <Card className="mb-8 animate-fade-in border-primary/20 hover:shadow-[var(--shadow-elegant)] transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-2xl">
              <Lightbulb className="h-6 w-6 text-amber-500" /> Suggestions from Respondents
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative p-5 bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl border-2 border-primary/20">
                ...
                <p className="text-muted-foreground italic">"More dustbins in public spaces."</p>
              </div>
              <div className="relative p-5 bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl border-2 border-primary/20">
                <div className="absolute -top-3 -left-3 w-8 h-8 bg-primary rounded-full flex items-center justify-center text-white font-bold">💬</div>
        ...
        {/* Conclusion */}
        <Card className="mb-8 animate-fade-in border-primary/20 bg-gradient-to-br from-primary/10 to-background hover:shadow-[var(--shadow-elegant)] transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-2xl">
              <CheckCircle className="h-6 w-6 text-primary" /> Conclusion
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="text-center p-4 bg-background rounded-lg">
                  <p className="text-3xl font-bold text-primary mb-2">High</p>
                  <p className="text-sm text-muted-foreground">Awareness</p>
                </div>
                <div className="text-center p-4 bg-background rounded-lg">
                  <p className="text-3xl font-bold text-destructive mb-2">Low</p>
                  <p className="text-sm text-muted-foreground">Implementation</p>
                </div>
                <div className="text-center p-4 bg-background rounded-lg">
                  <p className="text-3xl font-bold text-amber-500 mb-2">Gap</p>
                  <p className="text-sm text-muted-foreground">Practice vs Knowledge</p>
                </div>
              </div>
              ...
              <div className="text-center p-8 bg-gradient-to-r from-primary to-primary-light rounded-xl text-white">
                <p className="text-xl font-bold mb-2">📢 Call to Action</p>
                <p className="text-lg">
