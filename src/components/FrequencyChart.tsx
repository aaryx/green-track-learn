const FrequencyChart = () => {
  const data = [
    { label: 'Daily', value: 32.5, color: 'hsl(142, 76%, 36%)' },
    { label: 'Weekly', value: 24.8, color: 'hsl(142, 70%, 45%)' },
    { label: 'Alternate Days', value: 4.7, color: 'hsl(142, 60%, 55%)' },
    { label: 'Bi-weekly', value: 4.7, color: 'hsl(142, 50%, 65%)' },
    { label: 'Monthly', value: 15.2, color: 'hsl(142, 40%, 75%)' },
    { label: 'Rarely', value: 18.2, color: 'hsl(142, 30%, 85%)' },
  ];
